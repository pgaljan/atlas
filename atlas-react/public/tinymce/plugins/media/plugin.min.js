...
!(function () {
  ...
  const M = (e, t = {}) =>
    ...
    N = O.DOM,
    P = (e) => (/^[0-9.]+$/.test(e) ? e + "px" : e),
    R = (e, t) => {
      const r = t.attr("style"),
        o = r ? N.parseStyle(r) : {};
      s(e.width) && (o["max-width"] = P(e.width)),
        s(e.height) && (o["max-height"] = P(e.height)),
    ...
    (e) => (
      ...
      ((e) => {
        e.on("mousedown", (t) => {
          ...
          r &&
            "2" === e.dom.getAttrib(r, "data-mce-selected") &&
