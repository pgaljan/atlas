  ...
  const m = (t) => (e) => ((t) => t.dom.nodeType)(e) === t,
    ...
    w = (t) => {
      ...
      return ((t) => {
        ...
        return v((o = e)) && n(o.dom.host) ? a.some(e) : a.none();
        var o;
      })(d(e)).fold(
        () => o.body.contains(e),
        ((r = w), (i = p), (t) => r(i(t)))
    ...
    N = ("li", (t) => g(t) && "li" === t.dom.nodeName.toLowerCase());
  const A = (t, e, n) => {
      u(e, (e) => {
        const c = d(e),
          m = N(c),
        ...
        ((v = f), ((t) => a.from(t.dom.parentNode).map(d))(v).filter(g)).each(
          (e) => {
            if (
              ...
              u(e, (e) => {
                y(e, "dir"), t.setStyle(e.dom, "direction", null);
              });
            }
          }
        );
    ...
    T = (t, e) => {
      t.selection.isEditable() &&
        (A(t.dom, t.selection.getSelectedBlocks(), e), t.nodeChanged());
    },
    C = (t, e) => (o) => {
      const r = (r) => {
        const n = d(r.element);
        o.setActive(b(n) === e), o.setEnabled(t.selection.isEditable());
      };
      return (
        t.on("NodeChange", r),
