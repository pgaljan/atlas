...
const Syncfusion = () => {
  ...
  const flattenFilteredTree = (node, parentId = null, level = 0) => {
    ...
    const currentNode = {
      ...
      inputK: node.inputK ?? null,
      outputN: node.outputN ?? null,
          ...
          nodes={nodesData.map(node => {
            ...
            return {
              ...
              annotations: [
                ...
                ...(node.elementType === "gate" &&
                structureType !== "default" &&
                !(currentSearchTerm && shouldHighlight)
                ...
                node.id !== structureId
                  ? [
                      ...
                      {
                        id: `search-type-${node.id}`,
                        content: (node.elementType === "gate"
                          ? node.gateType || "GATE"
