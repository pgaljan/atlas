...
!(function () {
  ...
  const v = (e) => e.dom.nodeName.toLowerCase(),
    ...
    P = {
      ...
      fromDom: M,
      fromPoint: (e, t, o) => u.from(e.dom.elementFromPoint(t, o)).map(M),
    },
    O = (e, t) => {
      const o = e.dom;
    ...
    B = O,
    R = ((L = /^\s+|\s+$/g), (e) => e.replace(L, ""));
  var L;
  const $ = (e) => void 0 !== e.style && a(e.style.getPropertyValue),
    V = (e) => u.from(e.dom.parentNode).map(P.fromDom),
    I = (e) => u.from(e.dom.nextSibling).map(P.fromDom),
    j = (e) => h(e.dom.childNodes, P.fromDom),
    q = (e) => P.fromDom(e.dom.host),
    F = (e) => {
      const t = T(e) ? e.dom.parentNode : e.dom;
      if (null == t || null === t.ownerDocument) return !1;
      const o = t.ownerDocument;
      return ((e) => {
        const t = ((e) => P.fromDom(e.dom.getRootNode()))(e);
        return C((o = t)) && i(o.dom.host) ? u.some(t) : u.none();
        var o;
      })(P.fromDom(t)).fold(
        () => o.body.contains(t),
        ((n = F), (r = q), (e) => n(r(e)))
    ...
    H = (e, t) => ($(e) ? e.style.getPropertyValue(t) : ""),
    z = (e, t) => {
      V(e).each((o) => {
    ...
    _ = (e, t) => {
      ...
      return (
        f(j(e), (e) => {
          t(e) && (o = o.concat([e])), (o = o.concat(_(e, t)));
        }),
        o
      );
    },
    ...
    Q = (e, t, o) => G(e, (e) => O(e, t), o),
    W = (e, t) =>
      ((e, t) => {
        const o = void 0 === t ? document : t.dom;
        return k(o) ? u.none() : u.from(o.querySelector(e)).map(P.fromDom);
      })(t, e),
    X = ((e, t) => {
      const o = (t) => (e(t) ? u.from(t.dom.nodeValue) : u.none());
      return {
        get: (t) => {
  ...
  const ee = (e, t) => ({ element: e, offset: t }),
    ...
    ne = (e, t) => {
      ...
      if (e.property().isText(o)) return ee(o, oe(e, o));
      const n = e.property().children(o);
      return n.length > 0 ? ne(e, n[n.length - 1]) : ee(o, oe(e, o));
    },
    re = ne,
    se = {
      up: d({
      ...
      down: d({
        selector: (e, t) =>
          ((e, t) => {
            const o = void 0 === t ? document : t.dom;
            return k(o) ? [] : h(o.querySelectorAll(e), P.fromDom);
          })(t, e),
        predicate: _,
      }),
      styles: d({
        get: (e, t) => {
          ...
          return "" !== n || F(e) ? n : H(o, t);
        },
        getRaw: (e, t) => {
          const o = e.dom,
            n = H(o, t);
          return u.from(n).filter((e) => e.length > 0);
        },
        set: (e, t, o) => {
          ((e, t, o) => {
            if (!n(o))
            ...
            $(e) && e.style.setProperty(t, o);
          })(e.dom, t, o);
        },
        remove: (e, t) => {
          ((e, t) => {
            $(e) && e.style.removeProperty(t);
          })(e.dom, t),
            ((e, t, o = c) => e.exists((e) => o(e, t)))(
              D(e, "style").map(R),
              ""
            ) && E(e, "style");
        },
        ...
        prepend: (e, t) => {
          ((e) =>
            ((e, t) => {
              ...
              return u.from(o[0]).map(P.fromDom);
            })(e))(e).fold(
            () => {
              U(e, t);
            },
      ...
      remove: d({
        unwrap: (e) => {
          const t = j(e);
          t.length > 0 && Y(e, t), J(e);
        },
        remove: J,
      }),
      create: d({
        nu: P.fromTag,
        clone: (e) => P.fromDom(e.dom.cloneNode(!1)),
        text: P.fromText,
      }),
      query: d({
        comparePosition: (e, t) => e.dom.compareDocumentPosition(t.dom),
        prevSibling: (e) => u.from(e.dom.previousSibling).map(P.fromDom),
        nextSibling: I,
      }),
      property: d({
        children: j,
        ...
        parent: V,
        document: (e) => {
          return ((t = e), A(t) ? t : P.fromDom(t.dom.ownerDocument)).dom;
          var t;
        },
        isText: T,
        isComment: (e) => 8 === w(e) || "#comment" === v(e),
        isElement: N,
        isSpecial: (e) => {
          const t = v(e);
          return p(
        ...
        getLanguage: (e) => (N(e) ? D(e, "lang") : u.none()),
        getText: (e) => X.get(e),
        setText: (e, t) => X.set(e, t),
        isBoundary: (e) => !!N(e) && ("body" === v(e) || p(Z, v(e))),
        isEmptyTag: (e) => !!N(e) && p(["br", "img", "hr", "input"], v(e)),
        isNonEditable: (e) => N(e) && "false" === x(e, "contenteditable"),
      }),
      eq: (e, t) => e.dom === t.dom,
      is: B,
    },
  ...
  const ue = (e) => "SUMMARY" === (null == e ? void 0 : e.nodeName),
    ...
    fe = (e) => !he(e) && e.dom.isEditable(e.selection.getNode()),
    ye = (e) => u.from(e.dom.getParent(e.selection.getNode(), ge)),
    ...
    Ne = (e) => {
      ...
      const o = P.fromDom(e.getBody()),
        ...
        r = e.dom.encode(
          e.selection.getRng().toString() || e.translate("Accordion summary...")
        ),
        s = e.dom.encode(e.translate("Accordion body...")),
        i = `<summary class="${le}">${r}</summary>`,
        a = `<${ce} class="${de}"><p>${s}</p></${ce}>`;
      e.undoManager.transact(() => {
        e.insertContent(
          [
            `<details data-mce-id="${n}" class="${ae}" open="open">`,
            i,
            a,
            "</details>",
          ].join("")
        ),
          W(o, `[data-mce-id="${n}"]`).each((t) => {
            E(t, "data-mce-id"),
              W(t, "summary").each((t) => {
  ...
  const Se = (e) => {
    ...
    Me = (e) => {
      ...
      for (let e = 0; e < t.length; e++) {
        ...
        "summary" === a.name && s(o)
          ? (o = a)
          : (i = a).name === ce && p(Se(i), de) && s(n)
          ? (n = a)
          : r.push(a);
      }
      var i;
      return { summaryNode: o, wrapperNode: n, otherNodes: r };
    },
    Pe = (e) => {
      const t = new Ce("br", 1);
      t.attr("data-mce-bogus", "1"), e.empty(), e.append(t);
    };
  var Oe = tinymce.util.Tools.resolve("tinymce.util.VK");
  const ke = (e) => {
    ((e) => {
      e.on("keydown", (t) => {
        ((!t.shiftKey && t.keyCode === Oe.ENTER && he(e)) ||
          ((e) => {
  ...
  var Be = tinymce.util.Tools.resolve("tinymce.Env");
  const Re = (e) => (t) => {
        ...
        e.on("PreInit", () => {
          ...
          o.addNodeFilter(ie, (e) => {
            for (let t = 0; t < e.length; t++) {
              ...
              if (Ee(o)) {
                const e = o,
                  { summaryNode: t, wrapperNode: n, otherNodes: r } = Me(e),
                  a = i(t),
                  l = a ? t : new Ce("summary", 1);
                s(l.firstChild) && Pe(l),
                  xe(l, [le]),
                  a ||
                    (i(e.firstChild)
                      ? e.insert(l, e.firstChild, !0)
                      : e.append(l));
                const d = i(n),
                  c = d ? n : new Ce(ce, 1);
                if ((c.attr("data-mce-bogus", "1"), xe(c, [de]), r.length > 0))
            ...
            t.addNodeFilter(ie, (e) => {
              ...
              for (let o = 0; o < e.length; o++) {
                ...
                if (Ee(n)) {
                  const e = n,
                    { summaryNode: o, wrapperNode: r } = Me(e);
                  i(o) && De(o, t), i(r) && r.unwrap();
                }
              }
            });
        });
