...
!(function () {
  ...
  const o = ("function", (e) => "function" == typeof e);
  var n = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
  ...
  const a = (e) => (o) => o.options.get(e),
    ...
    l = (e) => (o) => {
      ...
      return (
        n(), e.on("NodeChange dirty", n), () => e.off("NodeChange dirty", n)
      );
    };
  e.add("save", (e) => {
    ((e) => {
      ...
      ((e) => {
        e.addCommand("mceSave", () => {
          ((e) => {
            const t = n.DOM.getParent(e.id, "form");
          ...
          e.addCommand("mceCancel", () => {
            ((e) => {
              const n = t.trim(e.startContent),
                a = s(e);
              o(a) ? a.call(e, e) : e.resetContent(n);
            })(e);
          });
      })(e);
  });
