          ...
          ((e, t, n) => {
            ...
            (e) => {
              ...
              return {
                ...
                html: t({
                  name: n,
                  url: `https://www.tiny.cloud/docs/tinymce/7/${e.slug}/`,
                }),
              };
            }
          );
  ...
  const F = (e, t, a) => () => {
    (async (e, t, a) => {
      const o = _(),
        ...
        u = { [o.name]: o, [s.name]: s, [l.name]: l, [m.name]: m, ...t.get() };
      return c.from(r(e)).fold(
        () =>
          ((e) => {
            const t = g(e),
          ...
          ((e, t) => {
            const a = {},
              r = y(e, (e) => {
                ...
                {
                  const t =
                    null !== (r = e.name) && void 0 !== r ? r : n("tab-name");
                  return (a[t] = e), t;
                }
              });
