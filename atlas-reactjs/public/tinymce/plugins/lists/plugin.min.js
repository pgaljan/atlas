...
!(function () {
  ...
  const f = Array.prototype.slice,
    ...
    z = (e) => {
      const t = j("ownerDocument.defaultView", e);
      return (
        r(e) &&
        (((e) =>
          ((e, t) => {
            const n = ((e, t) => j(e, t))(e, t);
            if (null == n)
              throw new Error(e + " not available on this browser");
            return n;
          })("HTMLElement", e))(t).prototype.isPrototypeOf(e) ||
          /^HTML\w*Element$/.test(K(e).constructor.name))
      );
    },
    Q = (e) => e.dom.nodeName.toLowerCase(),
    W = (e) => e.dom.nodeType,
    q = (e) => (t) => W(t) === e,
    Z = (e) => G(e) && z(e.dom),
    G = q(1),
    ...
    X = q(11),
    Y = (e) => (t) => G(t) && Q(t) === e,
    ee = (e) => h.from(e.dom.parentNode).map($),
    te = (e) => N(e.dom.childNodes, $),
    ne = (e, t) => {
      const n = e.dom.childNodes;
      return h.from(n[t]).map($);
    },
    oe = (e) => ne(e, 0),
    re = (e) => ne(e, e.dom.childNodes.length - 1),
    se = (e) => $(e.dom.host),
    ie = (e) => {
      const t = J(e) ? e.dom.parentNode : e.dom;
      if (null == t || null === t.ownerDocument) return !1;
      const n = t.ownerDocument;
      return ((e) => {
        const t = ((e) => $(e.dom.getRootNode()))(e);
        return X((n = t)) && l(n.dom.host) ? h.some(t) : h.none();
        var n;
      })($(t)).fold(
        () => n.body.contains(t),
        ((o = ie), (r = se), (e) => o(r(e)))
  ...
  var le = (e, t, n, o, r) =>
    e(n, o) ? h.some(n) : a(r) && r(n) ? h.none() : t(n, o, r);
  const ae = (e, t, n) => {
      let o = e.dom;
      const r = a(n) ? n : g;
      for (; o.parentNode; ) {
    ...
    de = (e, t, n) => le((e, t) => t(e), ae, e, t, n),
    ce = (e, t, n) => ae(e, (e) => _(e, t), n),
    me = (e, t) => {
      ee(e).each((n) => {
  ...
  var fe = tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"),
  ...
  const Ce = (e) => N(e, $),
    ...
    Le = (e) => O(e.dom.attributes, (e, t) => ((e[t.name] = t.value), e), {}),
    Oe = (e) => ((e, t) => $(e.dom.cloneNode(!0)))(e),
    Ae = (e, t) => {
      const n = ((e, t) => {
        const n = U(t),
          o = Le(e);
      ...
      var o, r;
      (r = n),
        ((e) => h.from(e.dom.nextSibling).map($))((o = e)).fold(
          () => {
            ee(o).each((e) => {
              ue(e, r);
            });
      ...
      const s = te(e);
      return pe(n, s), he(e), n;
    };
  var Te = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
    xe = tinymce.util.Tools.resolve("tinymce.util.Tools");
  const ke = (e) => (t) => l(t) && t.nodeName.toLowerCase() === e,
    Ee = (e) => (t) => l(t) && e.test(t.nodeName),
    we = (e) => l(e) && 3 === e.nodeType,
    De = (e) => l(e) && 1 === e.nodeType,
    Be = Ee(/^(OL|UL|DL)$/),
    Me = Ee(/^(OL|UL)$/),
    Pe = ke("ol"),
    Ie = Ee(/^(LI|DT|DD)$/),
    ...
    Ue = Ee(/^(TH|TD)$/),
    $e = ke("br"),
    _e = (e, t) => l(t) && t.nodeName in e.schema.getTextBlockElements(),
    He = (e, t) => l(e) && e.nodeName in t,
    Fe = (e, t) => l(t) && t.nodeName in e.schema.getVoidElements(),
    Ve = (e, t, n) => {
      const o = e.isEmpty(t);
      return (
    ...
    je = (e, t) => e.isChildOf(t, e.getRoot()),
    Ke = (e) => (t) => t.options.get(e),
    ze = Ke("lists_indent_on_tab"),
    Qe = Ke("forced_root_block"),
    We = Ke("forced_root_block_attrs"),
    qe = (e, t, n = {}) => {
      const o = e.dom,
      ...
      for (
        d = o.create(i, { ...l, ...(n.style ? { style: n.style } : {}) }),
          He(t.firstChild, r) || s.appendChild(d);
        (a = t.firstChild);

      ) {
        const e = a.nodeName;
        c ||
          ("SPAN" === e && "bookmark" === a.getAttribute("data-mce-type")) ||
          (c = !0),
          He(a, r)
      ...
      return (
        !c && d && d.appendChild(o.create("br", { "data-mce-bogus": "1" })), s
      );
    },
    Ze = Te.DOM,
    Ge = Y("dd"),
    ...
    Xe = (e, t) => {
      ...
      Ge(t)
        ? Ae(t, "dt")
        : Je(t) &&
          ((n = t), h.from(n.dom.parentElement).map($)).each((n) =>
            ((e, t, n) => {
              const o = Ze.select('span[data-mce-type="bookmark"]', t),
                r = qe(e, n),
                s = Ze.createRng();
              ...
              e.dom.isEmpty(i) || Ze.insertAfter(i, t), Ze.insertAfter(r, t);
    ...
    rt = (e, t) => {
      ...
      return e.dom.getParent(n, ot, lt(e, n));
    },
    st = (e) => {
      ...
      return L(
        ((e, t) => {
          const n = xe.map(
            t,
            (t) => e.dom.getParent(t, "li,dd,dt", lt(e, t)) || t
          );
          return B(n);
        })(e, t),
        Ie
    ...
    lt = (e, t) => {
      const n = e.dom.getParents(t, e.dom.isBlock),
        o = T(n, (t) => {
          return (
            ((t) => t.nodeName.toLowerCase() !== Qe(e))(t) &&
            ((n = e.schema),
            !Be((o = t)) &&
              !Ie(o) &&
              b(nt, (e) => n.isValidChild(o.nodeName, e)))
          );
          var n, o;
        });
    ...
    at = (e, t) => {
      const n = e.dom.getParents(t, "ol,ul", lt(e, t));
      return D(n);
    },
    dt = (e, t) => {
      const n = N(t, (t) => at(e, t).getOr(t));
      return B(n);
    },
    ct = (e) => /\btox\-/.test(e.className),
    mt = (e, t) => A(e, Be, Ue).exists((e) => e.nodeName === t && !ct(e)),
    ut = (e, t) => null !== t && !e.dom.isEditable(t),
    pt = (e, t) => {
    ...
    ft = (e, t, n) => e.dispatch("ListMutation", { action: t, element: n }),
    yt = ((vt = /^\s+|\s+$/g), (e) => e.replace(vt, ""));
  var vt;
  const Ct = (e, t, n) => {
      ((e, t, n) => {
        if (!o(n))
    ...
    bt = (e) => F(e, "OL,UL"),
    Nt = (e) => oe(e).exists(bt),
    St = (e) => "listAttributes" in e,
    Lt = (e) => "isComment" in e,
    Ot = (e) => e.depth > 0,
    At = (e) => e.isSelected,
    Tt = (e) => {
      const t = te(e),
        n = re(e).exists(bt) ? t.slice(0, -1) : t;
      return N(n, Oe);
    },
    xt = (e, t) => {
      ue(e.item, t.list);
    ...
    kt = (e, t) => {
      const n = { list: U(t, e), item: U("li", e) };
          ...
          Lt(o)
            ...
            ? ((e, t, n) => {
                const o = ((e, t, n) => {
                  const o = [];
                  for (let r = 0; r < n; r++)
                    o.push(kt(e, St(t) ? t.listType : t.parentListType));
                  return o;
                })(e, n, n.depth - t.length);
                var r;
                return (
                  ((e) => {
                    for (let t = 1; t < e.length; t++) xt(e[t - 1], e[t]);
                  })(o),
                  ((e, t) => {
                    for (let t = 0; t < e.length - 1; t++)
                      Ct(e[t].item, "list-style-type", "none");
                    D(e).each((e) => {
                      St(t) &&
                        (Se(e.list, t.listAttributes),
      ...
      S(e, (t, n) => {
        ((e, t) => {
          const n = e[t].depth,
            ...
            r = (e) => e.depth < n;
          return A(k(e.slice(0, t)), o, r).orThunk(() =>
            A(e.slice(t + 1), o, r)
          );
        })(e, n).fold(
          () => {
        ...
        .fold(
          ...
          (r) => {
            const s = O(
              ...
              (o, s, i) => {
                if (0 === i) return o;
                if (F(s, "LI")) return o.concat(Bt(e, t, n, s));
                {
                  const t = {
                    isFragment: !0,
                    depth: e,
            ...
            return Pt(e, t, n, r).concat(s);
          }
        ),
    Pt = (e, t, n, o) => x(te(o), (o) => (bt(o) ? Pt : Mt)(e + 1, t, n, o)),
    It = (e, t, n) => {
      const o = ((e, t) => {
        const n = ((e) => {
          let t = !1;
        ...
        return N(e, (e) => ({ sourceList: e, entries: Pt(0, t, n, e) }));
      })(
        t,
        ((e) => {
          const t = N(st(e), $);
          return P(T(t, p(Nt)), T(k(t), p(Nt)), (e, t) => ({
            start: e,
            end: t,
          }));
        })(e)
      ...
      S(o, (t) => {
          ...
          x(
            ...
            (t) =>
              w(t).exists(Ot)
                ? ((e, t) => {
                    const n = Dt(t);
                    return wt(e.contentDocument, n).toArray();
                  })(e, t)
                : ((e, t) => {
                    const n = Dt(t);
                    return N(n, (t) => {
                      const n = Lt(t)
                          ? ht([R(`\x3c!--${t.content}--\x3e`)])
                          : ht(t.content),
                        o = St(t) ? t.itemAttributes : {};
                      return $(qe(e, n.dom, o));
                    });
                  })(e, t)
          ))(e, t.entries);
        var r;
        S(o, (t) => {
          ft(e, "Indent" === n ? "IndentList" : "OutdentList", t.dom);
        }),
          (r = t.sourceList),
          S(o, (e) => {
            me(r, e);
    ...
    Rt = (e, t) => {
      const n = Ce(
          ((e) => {
            const t = ((e) => {
                const t = at(e, e.selection.getStart()),
                  n = L(e.selection.getSelectedBlocks(), Me);
                return t.toArray().concat(n);
              })(e),
              n = ((e) => {
                const t = e.selection.getStart();
                return e.dom.getParents(t, "ol,ul", lt(e, t));
              })(e);
            return T(n, (e) => {
              return (
                (t = $(e)),
                ee(t).exists(
                  (e) =>
                    Ie(e.dom) &&
                    oe(e).exists((e) => !Be(e.dom)) &&
                    re(e).exists((e) => !Be(e.dom))
                )
              );
              var t;
            }).fold(
      ...
      if (n.length || o.length) {
        ...
        It(e, n, t),
          ((e, t, n) => {
            S(n, "Indent" === t ? Ye : (t) => Xe(e, t));
          })(e, t, o),
          e.selection.moveToBookmark(s),
          e.selection.setRng(tt(e.selection.getRng())),
          e.nodeChanged(),
          (r = !0);
      }
      return r;
  ...
  const jt = Te.DOM,
            ...
            o.hasChildNodes()
              ? ((r = Math.min(r, o.childNodes.length - 1)),
                n
                  ...
                  : jt.insertAfter(e, o.childNodes[r]))
              : o.appendChild(e),
              (o = e),
              (r = 0);
          }
        ...
        if (n) {
          if (De(n) && n.parentNode) {
            ...
            (o = ((e) => {
              ...
              for (; n; ) {
                if (n === e) return o;
                (De(n) && "bookmark" === n.getAttribute("data-mce-type")) ||
                  o++,
                  (n = n.nextSibling);
              }
              return -1;
      ...
      ((e, t, n) => {
        ...
        ((e, t, n) => {
          Wt(t, n["list-attributes"]),
            xe.each(e.select("li", t), (e) => {
              Wt(e, n["list-item-attributes"]);
            });
        })(e, t, n);
    },
    Zt = (e, t) => l(t) && !He(t, e.schema.getBlockElements()),
    Gt = (e, t, n, o) => {
      let r = t[n ? "startContainer" : "endContainer"];
      const s = t[n ? "startOffset" : "endOffset"];
      De(r) && (r = r.childNodes[Math.min(s, r.childNodes.length - 1)] || r),
        !n && $e(r.nextSibling) && (r = r.nextSibling);
      const i = (t, n) => {
        var r;
        const s = new ye(
            t,
            ((t) => {
              for (; !e.dom.isBlock(t) && t.parentNode && o !== t; )
                t = t.parentNode;
              return t;
            })(t)
          ),
        ...
        for (; (l = s[i]()); )
          if (
            ...
            !Ft(l.textContent) &&
            0 !==
              (null === (r = l.textContent) || void 0 === r ? void 0 : r.length)
          )
            return h.some(l);
        return h.none();
      };
      if (n && we(r))
        if (Ft(r.textContent)) r = i(r, !1).getOr(r);
        else
          for (
            null !== r.parentNode && Zt(e, r.parentNode) && (r = r.parentNode);
            null !== r.previousSibling &&
            (Zt(e, r.previousSibling) || we(r.previousSibling));

          )
            r = r.previousSibling;
      if (!n && we(r))
        if (Ft(r.textContent)) r = i(r, !0).getOr(r);
        else
          for (
            null !== r.parentNode && Zt(e, r.parentNode) && (r = r.parentNode);
            null !== r.nextSibling &&
            (Zt(e, r.nextSibling) || we(r.nextSibling));
        ...
        a = L(
          ((e, t, n) => {
            ...
            return (
              xe.each(a, (t) => {
                var s;
                if (_e(e, t)) return o.push(t), void (l = null);
                if (r.isBlock(t) || $e(t))
                  return $e(t) && r.remove(t), void (l = null);
                const i = t.nextSibling;
                Vt.isBookmarkNode(t) &&
                (Be(i) || _e(e, i) || (!i && t.parentNode === n))
                  ? (l = null)
                  : (l ||
                      ((l = r.create("p")),
                      null === (s = t.parentNode) ||
    ...
    Xt = (e, t, n) => {
      return (
        ((e, t) => Be(e) && e.nodeName === (null == t ? void 0 : t.nodeName))(
          t,
          n
        ) &&
        ((e, t, n) =>
    ...
    en = (e, t, n, o) => {
      if (t.nodeName !== n) {
        ...
        qt(e.dom, r, o), ft(e, Qt(n), r);
      } else qt(e.dom, t, o), ft(e, Qt(n), t);
    },
    tn = (e, t, n, o) => {
      if (
    ...
    on = (e, t, n) => {
      ...
      const s = ((e) => {
          ...
          return ((e, t) => l(e) && 1 === t.length && t[0] === e)(t, n)
            ? ((e) => L(e.querySelectorAll(ot), Be))(t)
            : L(n, (e) => Be(e) && t !== e);
        })(e),
        i = r(n) ? n : {};
      s.length > 0
            ...
            if (t !== e.getBody())
              if (t)
                if (t.nodeName !== n || nn(o) || ct(t)) {
                  ...
                  Yt(e.dom, s),
                    e.selection.setRng(zt(r)),
                    Jt(e, n, o),
                    ft(e, Qt(n), s);
                } else Ht(e);
              else Jt(e, n, o), ft(e, Qt(n), t);
          })(e, o, t, i);
    },
    rn = Te.DOM,
    sn = (e, t) => {
      const n = xe.grep(e.select("ol,ul", t));
      xe.each(n, (t) => {
        ((e, t) => {
          ...
          if (n && "LI" === n.nodeName && n.firstChild === t) {
            ...
            o && "LI" === o.nodeName
              ? (o.appendChild(t), Ve(e, n) && rn.remove(n))
    ...
    ln = (e, t, n, o) => {
      ...
      if (we(r) && (n ? s < r.data.length : s > 0)) return r;
      const i = e.schema.getNonEmptyElements();
      De(r) && (r = fe.getNode(r, s));
      const l = new ye(r, o);
      n &&
        ((e, t) =>
          !!$e(t) && e.isBlock(t.nextSibling) && !$e(t.previousSibling))(
          e.dom,
          r
        ) &&
        l.next();
      ...
      for (; (r = a()); ) {
        ...
        if (we(r) && r.data.length > 0) return r;
      }
      return null;
    },
    an = (e, t) => {
      const n = t.childNodes;
      return 1 === n.length && !Be(n[0]) && e.isBlock(n[0]);
    },
    dn = (e) =>
      h
        .from(e)
    ...
    mn = (e, t, n) => {
      ...
      if (!je(e, t) || !je(e, n)) return;
      Be(n.lastChild) && (o = n.lastChild),
        r === n.lastChild &&
          $e(r.previousSibling) &&
          e.remove(r.previousSibling);
      const s = n.lastChild;
      s && $e(s) && t.hasChildNodes() && e.remove(s),
        Ve(e, n, !0) && ge($(n)),
        cn(e, t, n),
        o && n.appendChild(o);
      const i = ((e, t) => {
    ...
    un = (e, t) => {
      ...
      if (i) {
        ...
        if (r === e.getBody() && Ve(n, r)) return !0;
        const l = tt(o.getRng()),
          ...
          return (
            e.undoManager.transact(() => {
              ...
              t
                ...
                : (null === (o = (n = i).parentNode) || void 0 === o
                    ? void 0
                    : o.firstChild) === n
                ? _t(e)
                : ((e, t, n, o) => {
          ...
          return (
            e.undoManager.transact(() => {
              if (l.commonAncestorContainer.parentElement) {
                const t = Kt(l),
                  o = l.commonAncestorContainer.parentElement;
                cn(n, l.commonAncestorContainer.parentElement, a), o.remove();
                const r = zt(t);
    ...
    pn = (e) => {
      const t = e.selection.getStart(),
        n = it(e, t);
      return e.dom.getParent(t, "LI,DT,DD", n) || st(e).length > 0;
    },
    gn = (e, t) => {
      const n = e.selection;
      return (
        ...
        (n.isCollapsed()
          ? ((e, t) =>
              ...
              ((e, t) => {
                ...
                if (s && n.isEmpty(s, void 0, { checkRootAsContent: !0 })) {
                  const o = tt(e.selection.getRng()),
                    i = n.getParent(ln(e, o, t, r), "LI", r);
                  if (i) {
                    const l = (e) => C(["td", "th", "caption"], Q(e)),
                      a = (e) => e.dom === r;
                    return (
                      !!((e, t, n = u) =>
                        P(e, t, n).getOr(e.isNone() && t.isNone()))(
                        de($(i), l, a),
                        de($(o.startContainer), l, a),
                        H
                      ) &&
                      (e.undoManager.transact(() => {
          ...
          : ((e) =>
              !!pn(e) &&
              (e.undoManager.transact(() => {
                e.execCommand("Delete"), sn(e.dom, e.getBody());
              }),
              !0))(e))
      );
    },
    hn = (e) => {
      const t = k(yt(e).split("")),
        n = N(t, (e, t) => {
    ...
    yn = (e) => {
      ...
      return M(e.listStyleType, "upper-alpha")
        ? fn(t)
        : M(e.listStyleType, "lower-alpha")
        ? fn(t).toLowerCase()
        : e.start;
    },
    vn = (e, t) => () => {
  ...
  const Nn = (e) => 3 === e.type,
    ...
    Ln = (e) => {
      const t = (t, n) => {
        ...
        n = O(
          e.children(),
          (e, n) => (Nn(n) ? [...e, n] : Sn(e) || Nn(n) ? e : (t(e, n), [])),
          []
        );
      Sn(n) || t(n);
    },
    On = (e, t) => (n) => (
      ...
      gt(e, (o) => {
        n.setActive(mt(o.parents, t)),
          n.setEnabled(!pt(e, o.element) && e.selection.isEditable());
      })
    ),
    An = (e, t) => (n) =>
      gt(e, (o) => n.setEnabled(mt(o.parents, t) && !pt(e, o.element)));
  e.add(
    "lists",
    (e) => (
      ((e) => {
              ...
              ((e) => {
                e.on("keydown", (t) => {
                  t.keyCode !== ve.TAB ||
                    ve.metaKeyPressed(t) ||
                    e.undoManager.transact(() => {
                      (t.shiftKey ? _t(e) : $t(e)) && t.preventDefault();
                    });
                });
              })(e),
              ((e) => {
                    ...
                    null === n ||
                      ...
                      e.undoManager.transact(() => {
                        r(t.styles) && e.dom.setStyles(n, t.styles),
                          r(t.attrs) &&
                            Ne(t.attrs, (t, o) => e.dom.setAttrib(n, o, t));
                      });
                  })(e, n);
              }),
