...
!(function () {
    ...
    m =
      ...
      (...t) => {
        ...
        for (let o = 0; o < t.length; o++) {
          const n = t[o];
          for (const t in n) d(n, t) && (e[t] = h(e[t], n[t]));
        }
        return e;
      });
  var h;
  ...
  const f = (t) => (e) => e.options.get(t),
    ...
    j = f("emoticons_database_id"),
    C = f("emoticons_append"),
    _ = f("emoticons_images_url"),
    A = "All",
    k = {
      symbols: "Symbols",
      people: "People",
    ...
    E = (t, e) =>
      y(t.title.toLowerCase(), e) ||
      ((t, o) => {
        for (let o = 0, s = t.length; o < s; o++)
          if (((n = t[o]), y(n.toLowerCase(), e))) return !0;
        var n;
        return !1;
      })(t.keywords),
    L = (t, e, o) => {
    ...
    S = "pattern",
    N = (t, e) => {
      const n = { pattern: "", results: L(e.listAll(), "", a.some(300)) },
        s = l(A),
        r = ((t, e) => {
          let n = null;
          const s = () => {
          ...
          ((t) => {
            const o = t.getData(),
              n = s.get(),
              r = e.listCategory(n),
              i = L(r, o[S], n === A ? a.some(300) : a.none());
            t.setData({ results: i });
          })(t);
        }),
        c = { label: "Search", type: "input", name: S },
        ...
        d = t.windowManager.open(g());
      d.focus(S),
        e.hasLoaded() ||
          (d.block("Loading emojis..."),
          e
            .waitForLoad()
            .then(() => {
              d.redial(g()), r.throttle(d), d.focus(S), d.unblock();
            })
            .catch((t) => {
              d.redial({
                title: "Emojis",
  ...
  t.add("emoticons", (t, e) => {
    ((t, e) => {
      ...
      o("emoticons_database", { processor: "string", default: "emojis" }),
        ...
        o("emoticons_images_url", {
          processor: "string",
          default:
            "https://cdnjs.cloudflare.com/ajax/libs/twemoji/15.1.0/72x72/",
        });
    })(t, e);
    const o = ((t, e, o) => {
      const n = p(),
      ...
      const l = () => s.get().getOr([]),
        u = () => n.isSet() && s.isSet();
      return {
        listCategories: () => [A].concat(c(n.get().getOr({}))),
        hasLoaded: u,
        waitForLoad: () =>
          u()
            ? Promise.resolve(!0)
    ...
    return (
      ((t, e) => {
        t.addCommand("mceEmoticons", () => N(t, e));
      })(t, o),
      ((t) => {
