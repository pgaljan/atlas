...
!(function () {
  ...
  const b = Array.prototype.push,
    ...
    W = (e, t, n = 0, r) => {
      ...
      return -1 !== o && (!!u(r) || o + t.length <= r);
    },
    q = (e) => void 0 !== e.style && m(e.style.getPropertyValue),
    B = (e) => {
    ...
    _ = (e) => I(e.dom.ownerDocument),
    z = (e) => S(e.dom.childNodes, I),
    K = (e) => {
      const t = ((e) => I(e.dom.getRootNode()))(e);
      return N((n = t)) && d(n.dom.host) ? y.some(t) : y.none();
      var n;
    },
    $ = (e) => I(e.dom.host),
    U = (e) => {
      const t = D(e) ? e.dom.parentNode : e.dom;
    ...
    J = (e, t) => {
      ...
      return "" !== r || U(e) ? r : Q(n, t);
    },
    Q = (e, t) => (q(e) ? e.style.getPropertyValue(t) : ""),
    Z = (e) => {
      const t = I(
          ((e) => {
            if (d(e.target)) {
              const t = I(e.target);
              if (P(t) && d(t.dom.shadowRoot) && e.composed && e.composedPath) {
                const t = e.composedPath();
                if (t)
                  return ((e, t) => (0 < e.length ? y.some(e[0]) : y.none()))(
                    t
                  );
              }
            }
    ...
    ne = (e, t, n) =>
      ((e, t, n, r) =>
        ((e, t, n, r, o) => {
          ...
          return e.dom.addEventListener(t, s, o), { unbind: f(ee, e, t, s, o) };
        })(e, t, n, r, !1))(e, t, te, n),
    re = () => oe(0, 0),
    oe = (e, t) => ({ major: e, minor: t }),
    se = {
      nu: oe,
      detect: (e, t) => {
    ...
    ce = [
      ...
      },
      {
        name: "Chromium",
        brand: "Chromium",
        versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, le],
      ...
      {
        name: "Opera",
        versionRegexes: [le, /.*?opera\/([0-9]+)\.([0-9]+).*/],
        search: ae("opera"),
      },
      {
        name: "Firefox",
      ...
      {
        name: "Safari",
        versionRegexes: [le, /.*?cpu os ([0-9]+)_([0-9]+).*/],
        search: (e) =>
          (W(e, "safari") || W(e, "mobile/")) && W(e, "applewebkit"),
      },
    ],
    ue = [
      {
    ...
    we = () => ve({ current: void 0, version: se.unknown() }),
    ye = ve,
    be = (p(me), p(he), p("IE"), p(ge), p(pe), p(fe), "Windows"),
    Se = "Android",
    xe = "Linux",
    Ee = "macOS",
    Fe = "Solaris",
    ...
    Ce = () => Te({ current: void 0, version: se.unknown() }),
    Ae = Te,
    Re =
      (p(be),
      p("iOS"),
              ...
              ((e, t) =>
                ((e, t) => {
                  ...
                  return F(e, (e) => {
                    ...
                    current: e.name,
                    version: se.nu(parseInt(t.version, 10), 0),
                  }));
                }))(r, e)
            )
            .orThunk(() =>
              ((e, t) =>
                ie(e, t).map((e) => {
                  const n = se.detect(e.versionRegexes, t);
    ...
    Le = (e) => window.matchMedia(e).matches;
  let Me = ((e) => {
    let t,
      n = !1;
    return (...r) => (n || ((n = !0), (t = e.apply(null, r))), t);
  })(() =>
    Re(window.navigator.userAgent, y.from(window.navigator.userAgentData), Le)
  );
  const Pe = (e, t) => ({
      left: e,
      top: t,
      translate: (n, r) => Pe(e + n, t + r),
    }),
    De = Pe,
    Ne = (e) => {
      const t = void 0 === e ? window : e;
      return Me().browser.isFirefox() ? y.none() : y.from(t.visualViewport);
    },
    He = (e, t, n, r) => ({
      x: e,
      y: t,
    ...
    We = (e, t, n) =>
      Ne(n)
        ...
        .getOrThunk(() => ({ unbind: g }));
  var qe = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
    Be = tinymce.util.Tools.resolve("tinymce.Env");
  const Ie = (e, t) => {
      e.dispatch("FullscreenStateChanged", { state: t }),
        e.dispatch("ResizeEditor");
    },
    je = ("fullscreen_native", (e) => e.options.get("fullscreen_native"));
  const _e = (e) => {
      return (
        e.dom ===
        (void 0 !== (t = _(e).dom).fullscreenElement
          ? t.fullscreenElement
    ...
    Ke = (e, t) =>
      ((e, n) => {
        return E(
          ((e) => y.from(e.dom.parentNode).map(I))((r = e))
            .map(z)
            .map((e) =>
              E(e, (e) => {
    ...
    Ge = (e, t, n) => {
      const r = (t) => (n) => {
        ...
        i = ((e) => {
          ...
          return t;
        })(S(o, (e) => Ke(e, "*:not(.tox-silver-sink)"))),
        a = ((e) => {
          const t = J(e, "background-color");
          return void 0 !== t && "" !== t
            ? "background-color:" + t + "!important"
            : "background-color:rgb(255,255,255)!important;";
        })(n);
      x(i, r("display:none!important;")),
        x(o, r(Ue + Xe + a)),
        r((!0 === Ye ? "" : Ue) + Xe + a)(t);
    },
    Je = qe.DOM,
      ...
      (e) => {
        ...
        return {
          bind: (e) => {
            t.set(e),
              o.throttle(),
              n.set(We("resize", o.throttle)),
              r.set(We("scroll", o.throttle));
          },
          unbind: () => {
            t.on(() => {
              n.clear(), r.clear();
    ...
    Ze = (e, t) => {
      const n = document.body,
        ...
        o = e.getContainer(),
        s = I(o),
        i = ((l = s), y.from(l.dom.nextSibling).map(I)).filter(
          (e) =>
            ((e) => P(e) && L(e.dom))(e) &&
            ((e, t) =>
            ...
            ((e) => {
              const t = ((e, t) => {
                ...
                return (1 !== (r = n).nodeType &&
                  ...
                  ? []
                  : S(n.querySelectorAll(e), I);
                var r;
              })("[" + $e + "]");
              x(t, (t) => {
                const n = H(t, $e);
                n && "no-styles" !== n ? G(t, e.parseStyle(n)) : V(t, "style"),
                  V(t, $e);
              });
            })(e.dom),
            p(Je.removeClass),
            Qe.unbind(),
            y.from(t.get()).each((e) => e.fullscreenChangeHandler.unbind());
        };
      if (c)
        c.fullscreenChangeHandler.unbind(),
          ...
          w.isSome() && b.isSome()
            ? y.some(E(w.getOrDie(), b.getOrDie()))
            : y.none(),
          f(),
          (v = c.scrollPos),
        ...
        const n = ne(
          ...
          r = {
            ...
            sinkCssPosition: i.map((e) => J(e, "position")),
          };
        d && Ge(e.dom, s, u),
