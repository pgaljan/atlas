...
!(function () {
  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
      ...
      if (
        ((e, t) =>
          ...
          ((e, t) =>
            ...
            t.parentNode &&
            !e.isEditable(t.parentNode))(e, t))(e, n)
      )
        return;
      const a =
          null !== (s = e.getParent(r, e.isBlock)) && void 0 !== s
            ? s
            : e.getRoot(),
        l = new F(n, a),
      ...
      return (
        P(
          ...
          n,
          {
            ...
            text: (e) => {
              i.elements.push(T(e)), o && o.text(e, i);
            },
          },
          r,
          s
    ...
    _ = (e, t) => {
      w(e, (e, n) => {
        w(e, (e) => {
          ...
          if (s.length === e.finish && 0 === e.start) A(e.element, r);
          else {
              ...
              const o = n.getBookmark(),
                ...
                a =
                  s.length > 0
                    ...
                    : j(e, n.getRng()),
                l = U(t, a);
              return _(l, r), n.moveToBookmark(o), l.length;
            })(e.dom, n, e.selection, o)
          : ((e, t, n, r) => {
              const o = z(e, n),
                s = U(t, o);
              return _(s, r), s.length;
            })(e.dom, n, s, o)
      );
    },
    K = (e) => {
    ...
    J = (e, t, n) => {
      ...
      const a = H(e, o);
      return a.length
        ? (s.addClass(H(e, o), "mce-match-marker-selected"),
    ...
    te = (e, t, n) => {
      ...
      for (let e = 0; e < a.length; e++) {
        ...
        null !== t &&
          t.length &&
          (t === s.index.toString() &&
            (r || (r = a[e].firstChild), (o = a[e].firstChild)),
          K(a[e]));
      }
    ...
    ne = (t, n) => {
      ...
      t.undoManager.add();
      const o = f.trim(t.selection.getContent({ format: "text" })),
        s = (e) => {
          e.setEnabled("next", ((e, t) => t.get().count > 1)(0, n)),
            e.setEnabled("prev", ((e, t) => t.get().count > 1)(0, n));
        },
        a = (e, t) => {
          b(["replace", "replaceall", "prev", "next"], (n) =>
            e.setEnabled(n, !t)
          );
        },
        l = (e, t) => {
        ...
        y = (e, r) => ({
          ...
          initialData: r,
          onChange: (t, r) => {
            e && l(!1, t), "findtext" === r.name && n.get().count > 0 && d(t);
          },
          onAction: (e, r) => {
            const o = e.getData();
            switch (r.name) {
              case "find":
                ...
                break;
              case "replace":
                ee(t, n, o.replacetext) ? s(e) : d(e);
                break;
              case "replaceall":
                ee(t, n, o.replacetext, !0, !0), d(e);
                break;
              case "prev":
                Y(t, n), s(e);
                break;
      ...
      r.set(t.windowManager.open(y(!1, p), { inline: "toolbar" }));
    },
    re = (e, t) => () => {
      ne(e, t);
    };
