...
-- CreateEnum
CREATE TYPE "EditorType" AS ENUM ('vscode', 'quilleditor', 'markeddown', 'plantuml');

-- CreateEnum
CREATE TYPE "StructureType" AS ENUM ('default', 'faultTree');
...
CREATE TABLE "User" (
    ...
    "acceptedPrivacyPolicyId" TEXT,
    "acceptedTermsOfServiceId" TEXT,
...
CREATE TABLE "Structure" (
    ...
    "wbsStart" INTEGER NOT NULL DEFAULT 1,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
    "visibility" "Visibility" NOT NULL DEFAULT 'private',
    "type" "StructureType" NOT NULL DEFAULT 'default',
    "teamId" TEXT,
...
CREATE TABLE "Record" (
    ...
    "tags" JSONB,
    "editorType" "EditorType" NOT NULL DEFAULT 'vscode',
    "recordSvg" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
