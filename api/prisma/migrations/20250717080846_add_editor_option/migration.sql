/*
  ...
  - The values [quilleditor] on the enum `EditorType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EditorType_new" AS ENUM ('vscode', 'hugeRTEeditor', 'markeddown', 'plantuml');
